...
|---|---|---|---|
| **Informe de mejora (2026-09-22)** | Auditoria del PR contra el codigo: valida el informe OSS, corrige su diagnostico de la PSRAM, y encuentra bugs del flujo de barge-in que se arreglan solo en `bridge.py`. Es la fuente de las referencias §4.1/§4.2/§4.3 que citan el codigo y el CLAUDE.md. | [informe-mejora-2026-09-22.md](informe-mejora-2026-09-22.md) | — |
| **Investigacion: integracion con OSS** | Evaluacion de si conviene seguir sobre esta base o apoyarse en proyectos open source maduros (ESP-SR, ESPHome/HA Assist, Wyoming, Pipecat, LiveKit, sherpa-onnx). Incluye tabla comparativa, tres caminos con esfuerzo y riesgo, que NO hacer, y siete experimentos concretos. Cada afirmacion marcada como verificada o hipotesis. | [investigacion-integracion-oss.md](investigacion-integracion-oss.md) | — |
